...
def runAnalysis(input_file, output_file, file_type):
    # Endpoint URL
    endpoint = r"https://0831-fy22-fhir-appliedai-project-v2-formrecog.cognitiveservices.azure.com/"
    # Subscription Key
    apim_key = "45217d6dfc0b472595c06033c2000cce"
    # Model ID
    model_id = "78bc10ff-f27b-4db7-b3f2-167d48646f43"
    # API version
    API_version = "v2.1"
